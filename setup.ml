...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2b0193e097e84fa73f2450aef4139873) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build test suite";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "all", OASISExpr.EFlag "test"),
                             true)
                        ];
                      bs_install =
                        [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\210\157F\012\206fR\206\015q\182\026\0005\t&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
