...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b6c2f9295e54a4c340d8d47e2318a79) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.0.0");
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable gaussian process regression support";
                      flag_default =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "gpr", OASISExpr.EFlag "all"),
                             true)
                        ];
                      bs_install =
                        [
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "model-vis";
                           FindlibPackage ("gpr", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Vector"; "Gpr_model"; "Gpr_model_plot"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "model-vis";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Library
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "test-core"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "plot_all_test.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "y\222\160\220\168\141\003w\136^\173Y\156\189i\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
